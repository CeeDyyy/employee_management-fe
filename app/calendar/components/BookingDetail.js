...
const BookingDetail = ({ booking }) => {
    ...
    return (
        <details className="group rounded-md overflow-hidden shadow-lg">
            ...
            <div className="p-4 grid grid-cols-12 gap-y-2 items-start bg-sky-50 rounded-b-lg border-2 border-white">
                <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth={0} /><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" /><g id="SVGRepo_iconCarrier"> <path d="M5 21C5 17.134 8.13401 14 12 14C15.866 14 19 17.134 19 21M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z" stroke="#06b6d4" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" /> </g></svg>
                <p className="col-span-5 font-bold">ประเภทการลา</p>
                <p className="col-span-6">{booking.type}</p>
                <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M3 9H21M7 3V5M17 3V5M6 12H8M11 12H13M16 12H18M6 15H8M11 15H13M16 15H18M6 18H8M11 18H13M16 18H18M6.2 21H17.8C18.9201 21 19.4802 21 19.908 20.782C20.2843 20.5903 20.5903 20.2843 20.782 19.908C21 19.4802 21 18.9201 21 17.8V8.2C21 7.07989 21 6.51984 20.782 6.09202C20.5903 5.71569 20.2843 5.40973 19.908 5.21799C19.4802 5 18.9201 5 17.8 5H6.2C5.0799 5 4.51984 5 4.09202 5.21799C3.71569 5.40973 3.40973 5.71569 3.21799 6.09202C3 6.51984 3 7.07989 3 8.2V17.8C3 18.9201 3 19.4802 3.21799 19.908C3.40973 20.2843 3.71569 20.5903 4.09202 20.782C4.51984 21 5.07989 21 6.2 21Z" stroke="#06b6d4" stroke-width="2" stroke-linecap="round"></path> </g></svg>
                <p className="col-span-5 font-bold">ระยะเวลา<br/><span className="font-extralight">(เริ่มต้น)</span></p>
                <p className="col-span-6">{convertDateToThai(format(new Date(booking.start_date), 'd MMMM yyyy'))} {booking.start_date.slice(-5)}น.</p>
                <p className="col-start-2 col-span-5 font-extralight">(สิ้นสุด)</p>
                <p className="col-span-6">{convertDateToThai(format(new Date(booking.end_date), 'd MMMM yyyy'))} {booking.end_date.slice(-5)}น.</p>
                ...
                <p className="col-span-6">{convertDateToThai(format(new Date(booking.timestamp), 'd MMMM yyyy HH:mm'))} น.</p>
                ...
                <p className="col-span-6">{convertDateToThai(format(new Date(booking.updated), 'd MMMM yyyy HH:mm'))} น.</p>
